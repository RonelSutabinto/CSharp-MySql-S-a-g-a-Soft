...
Public Class SPA_Sales_CustDep
    Sub SPA_CustDep_Report()
        ...
        class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, gridControl, gridView, "SPA_CustDep_Report")
    End Sub

    Private Sub SPA_Sales_CustDep_Load(sender As Object, e As EventArgs) Handles MyBase.Load
