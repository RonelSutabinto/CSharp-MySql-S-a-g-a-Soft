...
Public Class SPA_Search_Sales
    Sub Show_SPA_Find_InventoryforSales()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Find_InventoryforSales")
    ...
    Sub Total()
        If txt_Quantity.Text = String.Empty Then
            txt_Quantity.Text = "0"
        End If
        txt_SubTotal.Text = CStr(Val(txt_Price.Text) * Val(txt_Quantity.Text))
    End Sub
