...
Public Class SPA_Branch
    ...
    Sub SPA_Find_SparePartsWithParam()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Find_SparePartsWithParam")
    ...
    Sub Show_SparePartsWithParam()
        ...
        Dim sqlParameters As SqlParameter() = {New SqlParameter("@ParamBranchCode", txt_BrCode.EditValue)}

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_ShowSparePartsWithParam")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                Do While myDataReader.Read()
                    Dim li As ListViewItem = lv_Parts.Items.Add(myDataReader.Item("ReceivingBranch").ToString())
                    li.SubItems.Add(myDataReader.Item("PartsNumber").ToString())
    ...
    Sub SPA_Find_SpareParts_ID()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Find_SpareParts_ID")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                myDataReader.Read()
    ...
    Sub SPA_BrandParameter()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_BrandParameter")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                Do While myDataReader.Read()
    ...
    Sub SPA_CategoryParameter()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_CategoryParameter")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                Do While myDataReader.Read()
    ...
    Private Sub lv_Parts_DoubleClick(sender As Object, e As EventArgs) Handles lv_Parts.DoubleClick
        ...
        If txt_Discount.EditValue Is String.Empty Or txt_CostWVAT.Text = String.Empty Or txt_CostWOVAT.Text = String.Empty Or txt_SRP.Text = String.Empty Or txt_SubTotal.Text = String.Empty Or txt_GrandTotal.Text = String.Empty Or txt_TotalCostWOVAT.Text = String.Empty Then
    ...
    Sub SPA_Inventory_Modify_SpareParts()
        ...
        class_Database.Procedure_Save(class_Database.SPAConnection, sqlParameters, "SPA_Inventory_Modify_SpareParts", "Modifiy SPA")
    End Sub
    ...
    Sub SPA_Inventory_Delete_SpareParts()
        ...
        class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Inventory_Delete_SpareParts", CBool("Delete SPA"))
    End Sub
    ...
    Private Sub txt_Quantity_EditValueChanged(sender As Object, e As EventArgs) Handles txt_Quantity.EditValueChanged
        txt_SubTotal.Text = CStr(Math.Round(Val(txt_Quantity.Text) * Val(txt_CostWVAT.Text), 2))
    End Sub

    Private Sub txt_CostWOVAT_EditValueChanged(sender As Object, e As EventArgs) Handles txt_CostWOVAT.EditValueChanged
        txt_CostWVAT.Text = CStr(Math.Round(Val(txt_CostWOVAT.Text) * Val(1.12), 2))
    End Sub
    ...
    Sub LV_PARTS_TotalQuantity()
        ...
        Next
        statusQuantity.Caption = CStr(TotalSum)
    End Sub
    ...
    Sub LV_PARTS_TotalCost()
        ...
        Next
        statusTotalCost.Caption = CStr(TotalSum)
    End Sub
    ...
    Sub LV_PARTS_TotalSRP()
        ...
        Next
        statusTotalSRP.Caption = CStr(TotalSum)
    End Sub

    Sub clear_Txt()
        txt_ID.Text = String.Empty
        txt_BranchCode.Text = CStr(txt_BrCode.EditValue)
        ...
        dtp_PostingDate.Text = CStr(Now())
        txt_Status.Text = "Approved"
        txt_Refno.Text = "000-MIGRATED"
        txt_POno.Text = "000-MIGRATED"
        txt_Branch.Text = class_Saga_Database.get_Branch_Name(class_Saga_Variables.sBranchCode)
        txt_Quantity.Text = "0"
        ...
        dtp_DateCheck.Text = CStr(Now())
        dtp_DateApproved.Text = CStr(Now())
