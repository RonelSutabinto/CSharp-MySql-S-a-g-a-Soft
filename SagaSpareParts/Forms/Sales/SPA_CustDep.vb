...
Public Class SPA_CustDep
    Sub SPA_Find_CRNo_CustDep()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Find_CRNo_CustDep")
    ...
    Sub SPA_AccountCode()
        ...
        Dim sqlParameters As SqlParameter() = {New SqlParameter("@ParamIsCommand", Me.Text)}

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_AccountCode")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                myDataReader.Read()
    ...
    Sub Show_InvoicesTransaction()
        ...
        Dim sqlParameters As SqlParameter() = {New SqlParameter("@ParamID", txt_ID.EditValue)}

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Show_Invoices")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                myDataReader.Read()
    ...
    Sub SPA_CustDep_Register()
        ...
        class_Database.Procedure_Save(class_Database.SPAConnection, sqlParameters, "SPA_CustDep_Register", "Customer Deposit")
    End Sub

    Sub SPA_Show_Mnemonic()
        Dim sqlParameters As SqlParameter() = {New SqlParameter("@ParamTransactions", cmb_Transaction.EditValue)}

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, sqlParameters, "SPA_Show_Mnemonic")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
