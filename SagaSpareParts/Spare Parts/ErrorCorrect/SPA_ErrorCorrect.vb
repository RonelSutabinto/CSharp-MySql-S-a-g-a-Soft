...
Public Class SPA_ErrorCorrect
    Sub SPA_Sales_Log()
        For x = 0 To lv_Parts.Items.Count - 1
            ...
            class_Database.Procedure_Save(class_Database.ICSConnection, Parameters, "SPA_Sales_Log", "Error Correct")
        Next
    End Sub
    ...
    Sub Transaction_Collection_To_SPA_Inventory()
        For x = 0 To lv_Parts.Items.Count - 1
            ...
            class_Database.Procedure_Save(class_Database.ICSConnection, Parameters, "Transaction_Collection_To_SPA_Inventory", "Error Correct")
        Next
