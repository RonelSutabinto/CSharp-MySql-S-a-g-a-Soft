...
Public Class SPA_Checker_Approver_Outgoing
    ...
    Sub SPA_Inventory_Check_ReceivingSpareParts()
        ...
        If txt_Approver.Text = class_Variables.sUserName Then
            MsgBox("Spare Parts Send! Please inform your Partsman.", vbInformation)
        ElseIf txt_Partsman.Text = class_Variables.sUserName Then
    ...
    Private Sub btn_Print_Click(sender As Object, e As EventArgs) Handles btn_Print.Click
        ...
        report.Parameters("DateTrans").Value = Date.Now
        ...
        report.Parameters("BranchFrom").Value = class_Saga_Variables.sBranchCode
