...
namespace MyClassLibrary.Classes
{
	public static class class_Database
	{
		...
		public static bool Procedure_BindData(string sConnection, SqlParameter[] sqlParameters, GridControl gridControl, GridView gridView, string sProcedureName, string sTable, bool sSplash = true)
		{
			...
			using (SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure })
			{
				...
				try
				{
					class_Procedures.splash_Show($"loading {sTable}", bForceShow: sSplash);
		...
		public static bool Procedure_BindData(string sConnection, SqlParameter[] sqlParameters, TreeList treeList, string sProcedureName, string sTable)
		{
			var MySQLConnection = new SqlConnection(sConnection);
			using (SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure })
			{
		...
		public static bool Procedure_Bind_Report(string sConnection, SqlParameter[] sqlParameters, XtraReport xRpt, string sProcedureName, string sTable)
		{
			var MySQLConnection = new SqlConnection(sConnection);
			using (SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure })
			{
				...
				{
					MyCommand.Parameters.AddRange(sqlParameters);
					class_Procedures.splash_Show($"executing/loading {sTable}", bForceShow: true);
					var da = new SqlDataAdapter(MyCommand);
					var ds = new DataSet();
					MySQLConnection.Open();
					ds.Clear();
		...
		public static SqlDataReader Procedure_Retrieve(string sConnection, SqlParameter[] sqlParameters, string sProcedureName, bool bSplash = false)
		{
			var MySQLConnection = new SqlConnection(sConnection);
			using SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure };
			MyCommand.Parameters.AddRange(sqlParameters);
			try
			{
				class_Procedures.splash_Show("Retrieving Information", bForceShow: bSplash);
				MySQLConnection.Open();
		...
		public static string Procedure_Get(string sConnection, SqlParameter[] sqlParameters, string sProcedureName, string sField, bool bSplash = false)
		{
			var MySQLConnection = new SqlConnection(sConnection);
			using SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure };
			MyCommand.Parameters.AddRange(sqlParameters);
		...
		public static bool Procedure_Retrieve(string sConnection, SqlParameter[] sqlParameters, GridControl gridControl, GridView gridView, string sProcedureName, string sTitle = "", bool bForceShow = false)
		{
			var MySQLConnection = new SqlConnection(sConnection);
			using SqlCommand MyCommand = new SqlCommand(sProcedureName, MySQLConnection) { CommandType = CommandType.StoredProcedure };
			MyCommand.Parameters.AddRange(sqlParameters);
		...
		public static bool Procedure_Save(string sConnection, SqlParameter[] sqlParameters, string sProcedureName, string sTitle, string sCode = "")
		{
			...
			try
			{
				class_Procedures.splash_Show($"Saving/Updating {sTitle}", bForceShow: class_Variables.bSplash);
				MySQLConnection.Open();
		...
		public static int Procedure_Execute(string sConnection, SqlParameter[] sqlParameters, string sProcedureName, string sTitle, bool bAsk = false)
		{
		...
		public static bool Bind_Data(string sConnection, TreeList treeList, string sQuery, string sTable)
		{
			var iNode = treeList.FocusedNode;
			try
			{
			...
			{
				treeList.SelectNode(iNode);
				treeList.FocusedNode = iNode;
				treeList.MakeNodeVisible(iNode);
			}
		}

		public static bool Bind_Data(string sConnection, GridControl gridControl, GridView gridView, string sQuery, string sTable)
		{
			...
			try
			{
				...
				iRow = (gridView.SelectedRowsCount > 0) ? gridView.FocusedRowHandle : 0;
		...
		public static bool Bind_Data(string sConnection, GridControl gridControl, GridView gridView, string sQuery, bool bClearColumns = true)
		{
			gridView.LoadingPanelVisible = true;
			if (bClearColumns)
		...
		public static bool Bind_Data(string sConnection, RepositoryItem repositoryItem, GridView gridView, string sQuery, string sTable)
		{
			try
			{
				gridView.LoadingPanelVisible = true;
		...
		public static bool Bind_Data(string sConnection, RepositoryItem repositoryItem, string sQuery, string sTable)
		{
			try
			{
				using (var ds = new DataSet())
		...
		public static bool Bind_Data(string sConnection, BaseEdit baseEdit, string sQuery, string sTable, bool bSplash = false)
		{
			try
			{
				using (DataSet ds = new DataSet())
		...
		public static bool Bind_Data(string sConnection, TreeListLookUpEdit treeList, string sQuery, string sTable)
		{
			try
			{
				using (var ds = new DataSet())
		...
		public static bool Bind_Report(string sConnection, XtraReport xRpt, string sQuery, string sTable)
		{
			try
			{
		...
		{
			int iCount = 0;
			string sQuery = bCustomQuery ? sCustomQuery : $"SELECT DISTINCT {sDistinctField} FROM {sTable} ORDER BY {sDistinctField} ASC";
		...
		{
			int iReturn = 0;
			string sQuery = bWhereCondition ? $"SELECT DISTINCT {sDistinctField} FROM {sTable} WHERE {sDistinctField} LIKE '{sWhereValue}' ORDER BY {sDistinctField} ASC" 
											: $"SELECT DISTINCT {sDistinctField} FROM {sTable} ORDER BY {sDistinctField} ASC";
		...
		public static string Get_Last_ID(string sConnection, string sTable, string sWhereCodeField, string sWherePreCodeValue, string sIDField = "ID", int iDash = 0)
		{
		...
		public static bool Query_Execute_Ask(string sTitle, string sQuery = "")
		{
			...
			return (XtraMessageBox.Show($"Do you want to execute this:{Environment.NewLine}{sTitle} {sQuery}?{Environment.NewLine}{Environment.NewLine}Note: You can't UNDO this operation.", $"{sTitle}", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question).Equals(DialogResult.Yes));
		}
