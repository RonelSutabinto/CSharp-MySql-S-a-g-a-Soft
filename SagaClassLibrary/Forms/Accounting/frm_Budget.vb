...
Namespace Forms.Accounting
    ...
    Public Class frm_Budget
        ...
        Public Sub New()
            ...
            class_Procedures.Initialize_Form(Me, xuc_Budget.layoutControl, BtnCancel)
        ...
        Private Sub frm_Budget_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        ...
        Private Sub frm_Budget_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
            If Not Form_Close() Then e.Cancel = True
        End Sub

        Private Sub btn_Save_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Save.ItemClick

            xuc_Budget.Control_Save()
        End Sub
        ...
        Private Sub btn_Save_Close_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Save_Close.ItemClick
            ...
            If xuc_Budget.Control_Save() Then Form_Close()
        End Sub
