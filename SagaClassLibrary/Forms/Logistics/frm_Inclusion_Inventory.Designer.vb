Namespace Forms.Logistics
    Partial Class frm_Inclusion_Inventory
        ...
        Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frm_Inclusion_Inventory))
            Me.gridControl = New DevExpress.XtraGrid.GridControl()
            Me.gridView = New DevExpress.XtraGrid.Views.Grid.GridView()
            Me.colID = New DevExpress.XtraGrid.Columns.GridColumn()
            Me.colInclusion_Code = New DevExpress.XtraGrid.Columns.GridColumn()
            Me.colInventory_Code = New DevExpress.XtraGrid.Columns.GridColumn()
            Me.colEngine = New DevExpress.XtraGrid.Columns.GridColumn()
            Me.colInclusion_Type = New DevExpress.XtraGrid.Columns.GridColumn()
            Me.colInclusion_Name = New DevExpress.XtraGrid.Columns.GridColumn()
            ...
            Me.xuc_Inclusion_Inventory = New SagaClassLibrary.Controls.Logistics.xuc_Inclusion_Inventory()
            ...
            'gridView
            '
            Me.gridView.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {Me.colID, Me.colInclusion_Code, Me.colInventory_Code, Me.colEngine, Me.colInclusion_Type, Me.colInclusion_Name, Me.colDescription, Me.colNotes, Me.colAdded_By, Me.colAdded_Date, Me.colModified_By, Me.colModified_Date})
            ...
            'colInclusion_Code
            '
            Me.colInclusion_Code.Caption = "Code"
            Me.colInclusion_Code.FieldName = "Inclusion_Code"
            Me.colInclusion_Code.Name = "colInclusion_Code"
            Me.colInclusion_Code.Visible = True
            Me.colInclusion_Code.VisibleIndex = 1
            '
            'colInventory_Code
            '
            Me.colInventory_Code.FieldName = "Inventory_Code"
            Me.colInventory_Code.Name = "colInventory_Code"
            Me.colInventory_Code.Visible = True
            Me.colInventory_Code.VisibleIndex = 2
            '
            'colEngine
            '
            ...
            'colInclusion_Type
            '
            Me.colInclusion_Type.Caption = "Type"
            Me.colInclusion_Type.FieldName = "Inclusion_Type"
            Me.colInclusion_Type.Name = "colInclusion_Type"
            Me.colInclusion_Type.Visible = True
            Me.colInclusion_Type.VisibleIndex = 3
            '
            'colInclusion_Name
            '
            Me.colInclusion_Name.Caption = "Name"
            Me.colInclusion_Name.FieldName = "Inclusion_Name"
            Me.colInclusion_Name.Name = "colInclusion_Name"
            Me.colInclusion_Name.Visible = True
            Me.colInclusion_Name.VisibleIndex = 5
            '
            'colDescription
            '
            ...
            Me.barManager.Items.AddRange(New DevExpress.XtraBars.BarItem() {Me.btn_Reload, Me.btn_Close, Me.btn_New, Me.btn_Delete, Me.btn_Save, Me.btn_Preview, Me.btn_Initialize, Me.BarEditItem_Search, Me.btn_Receive})
            ...
            Me.bar1.LinksPersistInfo.AddRange(New DevExpress.XtraBars.LinkPersistInfo() {New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Initialize), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Reload), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Preview), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_New, True), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Receive), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Save), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Delete), New DevExpress.XtraBars.LinkPersistInfo(Me.btn_Close, True)})
            Me.bar1.Offset = 115
            Me.bar1.Text = "Tools"
            '
            'btn_Initialize
            ...
            '
            Me.dockPanel1_Container.Controls.Add(Me.xuc_Inclusion_Inventory)
            ...
            '
            Me.xuc_Inclusion_Inventory.Dock = System.Windows.Forms.DockStyle.Fill
            Me.xuc_Inclusion_Inventory.Location = New System.Drawing.Point(0, 0)
            Me.xuc_Inclusion_Inventory.Name = "xuc_Inclusion_Inventory"
            Me.xuc_Inclusion_Inventory.Size = New System.Drawing.Size(293, 428)
            Me.xuc_Inclusion_Inventory.TabIndex = 0
            '
            'dockPanel2
            '
            ...
            Me.Name = "frm_Inclusion_Inventory"
        ...
        Friend WithEvents colInclusion_Code As DevExpress.XtraGrid.Columns.GridColumn
        Friend WithEvents colInclusion_Name As DevExpress.XtraGrid.Columns.GridColumn
        Friend WithEvents colInclusion_Type As DevExpress.XtraGrid.Columns.GridColumn
        ...
        Friend WithEvents xuc_Inclusion_Inventory As Controls.Logistics.xuc_Inclusion_Inventory
        Friend WithEvents colInventory_Code As DevExpress.XtraGrid.Columns.GridColumn
