...
Namespace Forms.Logistics
    ...
    Public Class frm_Inclusions
        Inherits DevExpress.XtraEditors.XtraForm

        Public Sub New()
            If xuc_Inclusion Is Nothing Then
                Me.xuc_Inclusion = New Controls.Logistics.xuc_Inclusion()
            End If
            ...
            class_Procedures.Initialize_Form(Me, dockManager, gridView, BtnCancel, xuc_Inclusion.LayoutControl, xuc_Settings)
        ...
        Private Sub frm_Inclusions_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
            If xuc_Settings.Toggle_Auto_Initialize.IsOn Then xuc_Inclusion.Control_Initialize()
            If xuc_Settings.Toggle_Auto_Reload.IsOn Then Data_Load()
        End Sub

        Private Function Form_Close() As Boolean
            Return class_Procedures.Form_Close(Me, barManager, dockManager, gridView, xuc_Inclusion.LayoutControl, xuc_Settings, Control.ModifierKeys = Keys.Shift, True)
        End Function
        ...
        Private Sub btn_Initialize_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Initialize.ItemClick
            xuc_Inclusion.Control_Initialize()
        End Sub
        ...
        Private Sub Data_Load()
            ...
            class_Database.Procedure_Retrieve(class_Database.ICSConnection, sqlParameters, gridControl, gridView, "inv_Inclusion_Procedures", "Inclusions List")
        End Sub
        ...
        Private Sub Data_Show()
            If gridView.RowCount > 0 Then
                With xuc_Inclusion
                    ...
                    .Inclusion_Code.Text = gridView.GetFocusedRowCellDisplayText(colInclusion_Code)
                    .Inclusion_Name.Text = gridView.GetFocusedRowCellDisplayText(colInclusion_Name)
                    .Inclusion_Type.Text = gridView.GetFocusedRowCellDisplayText(colInclusion_Type)
        ...
        Private Sub btn_New_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_New.ItemClick
            xuc_Inclusion.Control_New(xuc_Settings.Toggle_Clear_On_Action.IsOn)
        End Sub
        ...
        Private Sub btn_Save_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Save.ItemClick
            If xuc_Inclusion.Control_Save() AndAlso xuc_Settings.Toggle_Auto_Reload.IsOn Then Data_Load()
        End Sub
        ...
        Private Sub btn_Delete_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Delete.ItemClick
            'If xuc_Inclusion.Control_Delete() Then
