...
Namespace Reports.Accounting
    Public Class xrpt_Financial_Performance
        Private Sub xrpt_Financial_Performance_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
