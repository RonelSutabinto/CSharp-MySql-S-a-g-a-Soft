...
Namespace Reports.Accounting
    Public Class xrpt_Balance_Sheet
        Private Sub xrpt_Balance_Sheet_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
