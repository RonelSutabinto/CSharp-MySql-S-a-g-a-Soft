...
Namespace Reports.Logistics
    ...
    Public Class xrpt_Purchase_Order_Received

        Private Sub xrpt_Purchase_Order_Received_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
