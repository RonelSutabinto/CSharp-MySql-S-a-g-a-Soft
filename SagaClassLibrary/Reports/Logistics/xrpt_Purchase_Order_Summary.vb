...
Namespace Reports.Logistics
    ...
    Public Class xrpt_Purchase_Order_Summary

        Private Sub xrpt_Purchase_Order_Summary_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
