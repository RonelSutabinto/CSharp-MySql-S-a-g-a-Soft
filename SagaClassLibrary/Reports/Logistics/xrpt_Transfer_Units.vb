...
Namespace Reports.Logistics
    ...
    Public Class xrpt_Transfer_Units

        Private Sub xrpt_Transfer_Units_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
