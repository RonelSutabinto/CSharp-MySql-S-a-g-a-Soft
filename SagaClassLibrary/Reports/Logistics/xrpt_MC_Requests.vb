...
Namespace Reports.Logistics
    ...
    Public Class xrpt_MC_Requests

        Private Sub xrpt_MC_Requests_BeforePrint(sender As Object, e As Drawing.Printing.PrintEventArgs) Handles MyBase.BeforePrint
