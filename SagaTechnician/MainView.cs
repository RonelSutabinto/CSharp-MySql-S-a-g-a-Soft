...
namespace SagaTechnician
{
    public partial class MainView : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        {
            var frm_Ticket = new SagaSupport.Forms.frm_Ticket();
            class_Procedures.Show_Form(this, frm_Ticket, "New Ticket", false);
        }

        private void Btn_Tickets_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            var frm_Tickets = new SagaSupport.Forms.frm_Tickets();
            class_Procedures.Show_Form(this, frm_Tickets, "Ticket Management");
        }
        ...
        private void Btn_New_Asset_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            class_Procedures.Show_Form(this, frm_Asset, "New Asset Item", false);
        }

        private void Btn_Assets_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            var frm_Assets = new SagaAssets.Forms.frm_Assets();
            class_Procedures.Show_Form(this, frm_Assets, "Asset Items");
        }
