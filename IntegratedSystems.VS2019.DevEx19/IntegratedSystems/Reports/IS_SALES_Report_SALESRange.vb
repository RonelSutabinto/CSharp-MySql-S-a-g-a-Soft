...
Public Class IS_SALES_Report_SALESRange
    Private Sub IS_SALES_Report_SALESRange_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        cmb_BranchName.Text = String.Empty
    ...
    private sub cmd_showInvent_Click(sender As System.Object, e As System.EventArgs) Handles cmd_showInvent.Click
        ...
        'Dim reportPath As String = System.IO.Path.Combine(System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "ListofSALESRange.rpt")
        ...
        'Crystal_Report.SetParameterValue("TransactionDateFrom", dateFrom.Text)
        'Crystal_Report.SetParameterValue("TransactionDateTo", dateTo.Text)
