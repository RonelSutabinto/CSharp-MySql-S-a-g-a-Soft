...
Public Class rpt_MCAccountPromo
    ...
    Private Sub rpt_MCAccountPromo_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub rpt_MCAccountPromo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btn_Reload_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Reload.ItemClick
        ...
        class_Database.Procedure_Retrieve(class_Database.ICSConnection, sqlParameters, gridControl, gridView, "mg_ShowAccountWPromo")
