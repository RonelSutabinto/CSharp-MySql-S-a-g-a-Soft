...
Public Class Customers_Information_find
    ...
    private sub Data_Load()
        ...
        Try
            ...
            class_Database.Procedure_Retrieve(class_Database.ICSConnection, sqlParameters, gridControl, gridView, "mg_ShowCIFAccounts_Quick_find", "CIFACCOUNTS")
    ...
    '        Dim li As ListViewItem = LViewItems.Items.Add(myDataReader.Item("CIFKey").ToString())
    '        li.SubItems.Add(myDataReader.Item("FullName").ToString())
    '        dt = Format(convert.todatetime(myDataReader.Item("Bday").ToString()), "yyyy-MM-dd")
    '        li.SubItems.Add(dt)
    '        li.SubItems.Add(myDataReader.Item("Gender").ToString())
    '    
    '    End Using
