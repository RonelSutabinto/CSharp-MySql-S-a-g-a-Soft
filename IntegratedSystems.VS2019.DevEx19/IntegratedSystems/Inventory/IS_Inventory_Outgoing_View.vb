...
Public Class IS_Inventory_Outgoing_View
    ...
    private sub IS_Inventory_Outgoing_View_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        If class_saga_variables.sbranchcode = txt_originatingBranch.Text Then
        Else
            txt_receiver.EditValue = class_Variables.sUserName
            txt_receiver.Text = class_Variables.sUserName
            txt_receiver.Enabled = False
            searchBranchApprover()
        End If
    End Sub

    private sub searchBranchApprover()
    ...
    private sub Approveditems_SameBranch()
        ...
        class_Database.Procedure_Save(class_Database.ICSConnection, sqlParameters, "mg_Inventory_ItemApproval", "Approved Unit Items", txt_refno.Text)

        cmd_print.Location = New Point(13, 441)
        cmd_print.Visible = True
    End Sub

    private sub Approveditems_InterBranch()
        Dim sqlParameters As SqlParameter() = {
            New SqlParameter("@ParamBranchCode", class_saga_variables.sbranchcode),
            New SqlParameter("@ParamRefNo", txt_refno.Text),
            New SqlParameter("@ParamPONo", txt_pono.Text),
        ...
        class_Database.Procedure_Save(class_Database.ICSConnection, sqlParameters, "mg_Inventory_ItemApproval", "Approved Inter-Branch Unit Items", txt_refno.Text)
    ...
    private sub DisApproveditems()
        ...
        class_Database.Procedure_Save(class_Database.ICSConnection, sqlParameters, "mg_Inventory_ItemDisapproved", "Disapproved Unit Items", "txt_refno.Text")
    End Sub
