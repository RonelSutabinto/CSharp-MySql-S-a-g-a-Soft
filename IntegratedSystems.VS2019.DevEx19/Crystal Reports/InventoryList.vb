...
Public Class InventoryList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegratedSystems.InventoryList.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_IfExist() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedInventoryList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As InventoryList = New InventoryList()
        rpt.Site = Me.Site
        Return rpt
    End Function
