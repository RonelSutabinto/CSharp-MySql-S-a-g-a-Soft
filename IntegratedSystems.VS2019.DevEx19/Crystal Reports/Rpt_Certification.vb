...
Public Class Rpt_Certification
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegratedSystems.Rpt_Certification.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Certification
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Certification = New Rpt_Certification()
        rpt.Site = Me.Site
        Return rpt
    End Function
