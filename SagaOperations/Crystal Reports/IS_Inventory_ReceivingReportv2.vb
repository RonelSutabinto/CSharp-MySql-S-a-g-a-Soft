...
Public Class IS_Inventory_ReceivingReportv2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "IS_Inventory_ReceivingReportv2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegratedSystems.IS_Inventory_ReceivingReportv2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false), _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)> _
    Public ReadOnly Property Parameter_whcode() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedIS_Inventory_ReceivingReportv2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IS_Inventory_ReceivingReportv2 = New IS_Inventory_ReceivingReportv2()
        rpt.Site = Me.Site
        Return rpt
    End Function
