...
Public Class rpt_genpay_first
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IntegratedSystems.rpt_genpay_first.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_genpay_first
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_genpay_first = New rpt_genpay_first()
        rpt.Site = Me.Site
        Return rpt
    End Function
