...
Public Class Admin_BackupAppl
    ...
    Private Sub Admin_BackupAppl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        txt_URL.Text = class_Tools.RegKeyGet("Application", "UpdateURL", "UpdateURL")
        txt_changeLog.Text = class_Tools.RegKeyGet("Application", "ChangeLog", "ChangeLog")
        txt_LocPath.Text = class_Tools.RegKeyGet("Application", "FilePath", "FilePath")
    ...
    Private Sub btn_Save_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles Btn_Save.ItemClick
        class_Tools.RegKeySet("Application", "UpdateURL", txt_URL.Text)
        class_Tools.RegKeySet("Application", "ChangeLog", txt_changeLog.Text)
        class_Tools.RegKeySet("Application", "FilePath", txt_LocPath.Text)
    End Sub
    ...
    Private Sub btn_Execute_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles Btn_Execute.ItemClick
        class_Procedures.splash_Show("Back up file/s ongoing.")
        CreateXML()
    ...
    Sub CreateXML()
        ...
        writer.WriteString(Convert.ToBoolean(TMandatory.EditValue).ToString.ToLower)
        writer.WriteEndElement()
