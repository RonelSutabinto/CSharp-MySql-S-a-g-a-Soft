...
Public Class IS_Inventory_TransactionReports_ApprovedTransfers
    ...
    Sub searchTransType()
        ...
        Dim Parameters As SqlParameter() = {
            New SqlParameter("@ParamOriginatingBranch", MainMenu.statusBrCode.Caption),
            New SqlParameter("@ParamInvStatus", txt_trans.Text),
            New SqlParameter("@ParamTransactedBy", MainMenu.App_User_Name.Caption)
        }

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.ICSConnection, Parameters, "mg_ShowApprovedTransfersMC")
