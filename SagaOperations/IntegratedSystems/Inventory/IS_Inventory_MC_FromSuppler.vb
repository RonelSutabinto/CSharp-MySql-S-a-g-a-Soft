...
Public Class IS_Inventory_MC_FromSuppler
    ...
    Sub searchInventoryHoPerWHCode()
        Dim Parameters As SqlParameter() = {}

        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.ICSConnection, Parameters, "mg_showitemwh")
