...
Public Class frm_SPA_Purchase_Orders
    Dim sBrCode, sModelCode, sModelName, sColor, sCategory, sPartNumber, sPartName, sType As String
    ...
    Private Sub Frm_Purchase_Orders_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        class_Saga_Variables.Initialize_Categories()
        class_Saga_Procedures.Initialize_Category(RepositoryItemLookUpEdit_Category)
    End Sub
    ...
    Private Sub Btn_Initialize_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles Btn_Initialize.ItemClick
        ...
        'class_Saga_Procedures.Initialize_MC_Model(RepositoryItemLookUpEdit_Model_Code, "Model_Code")
    ...
    Private Sub RepositoryItemComboBox_Type_EditValueChanged(sender As Object, e As EventArgs) Handles RepositoryItemComboBox_Type.EditValueChanged
        Try
            sType = CType(sender, BaseEdit).EditValue.ToString
        Catch Ex As Exception
        End Try
    End Sub

    Private Sub RepositoryItemLookUpEdit_Category_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles RepositoryItemLookUpEdit_Category.Validating

    End Sub

    Private Sub RepositoryItemLookUpEdit_Category_EditValueChanged(sender As Object, e As EventArgs) Handles RepositoryItemLookUpEdit_Category.EditValueChanged
        'Try
        sCategory = CType(sender, BaseEdit).EditValue.ToString
            class_Saga_Variables.Initialize_Part_Number(Xuc_SPA_Purchase_Orders.Brand.Text, sCategory)
            class_Saga_Procedures.Initialize_Parts_Number(RepositoryItemLookUpEdit_Parts_Number)
        ' Catch Ex As Exception
        'End Try
    End Sub
    ...
    Private Sub RepositoryItemCalcEdit_Rebates_EditValueChanged(sender As Object, e As EventArgs) Handles RepositoryItemCalcEdit_Rebates.EditValueChanged
        Try
            dRebates = CType(sender, BaseEdit).EditValue
        Catch Ex As Exception
        End Try
    End Sub
            ...
            With GridView_Items
                Select Case e.Column.Name
                    Case "colQuantity", "colRebates"
                        ...
                        Dim dTotalRebates As Decimal = .GetFocusedRowCellValue(colRebates) * .GetFocusedRowCellValue(colQuantity)
                        Dim dNetProfit As Decimal = dTotalSRP - 0 + dTotalRebates
                        '.SetRowCellValue(e.RowHandle, colTotal_Cost2, dTotalCost)
                        .SetRowCellValue(e.RowHandle, colTotal_SRP, dTotalSRP)
                        .SetRowCellValue(e.RowHandle, colTotal_Rebates, dTotalRebates)
                        .SetRowCellValue(e.RowHandle, colNet_Profit, dNetProfit)
                    Case "colUnit_Cost"
    ...
    Private Sub GridView_Items_InitNewRow(sender As Object, e As Grid.InitNewRowEventArgs)
        ...
        view.SetRowCellValue(e.RowHandle, colRebates, dRebates)
        view.SetRowCellValue(e.RowHandle, colQuantity, iQuantity)
        view.SetRowCellValue(e.RowHandle, colCartons, iCartons)
                ...
                For i As Integer = 0 To .DataRowCount - 1
                    ...
                    Try
                        ...
                        Dim UnitParameters As SqlParameter() = {New SqlParameter("@ID", iID),
                                                                New SqlParameter("@Branch", class_Saga_Variables.sBranchCode),
                                                                New SqlParameter("@Order_Type", .GetRowCellDisplayText(i, colOrder_Type)),
                                                                ...
                                                                New SqlParameter("@Cartons", .GetRowCellValue(i, colCartons)),
                                                                ...
                                                                New SqlParameter("@Total_Rebates", .GetRowCellValue(i, colTotal_Rebates)),
