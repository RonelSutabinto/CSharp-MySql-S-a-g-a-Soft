...
Public Class SPA_Sales_Inquiry
    Private Sub SPA_Sales_Inquiry_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lbl_Total.Text = Val(txt_Balance.EditValue)
        ColorChanged()
        SPA_Show_Ledger()
        If txt_Balance.EditValue = "0.00" Then
    ...
    Sub ColorChanged()
        If txt_Balance1.EditValue = "0.00" Then
            txt_Status.EditValue = "CLOSED"
            txt_Status1.EditValue = "CLOSED"
        End If
        If txt_Status.EditValue LIKE "OVERDUE" Or txt_Status.Text LIKE "overdue" Or txt_Status.Text LIKE "overdue " Or txt_Status.Text LIKE " overdue" Or txt_Status.Text LIKE "OVERDUE " Or txt_Status.Text LIKE "Overdue" Then
    ...
    Sub SPA_AddtoLedger()
        ...
        class_Database.Procedure_Save(class_Database.SPAConnection, Parameters, "SPA_AddtoLedger", "Update Ledger")
    End Sub
    ...
    Sub SPA_ModifySales_Collection()
        ...
        If class_Database.Procedure_Save(class_Database.SPAConnection, Parameters, "SPA_ModifySales_Collection", "Sale Collection") Then
    ...
    Sub SPA_Show_Ledger()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.SPAConnection, Parameters, "SPA_Show_Ledger")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                Do While myDataReader.Read()
    ...
    Private Sub toolPost_Click(sender As Object, e As EventArgs) Handles toolPost.Click
        If txt_CRNumber.EditValue = "0" Or txt_CRNumber.Text = String.Empty Then
            MsgBox("Please Supply CR Number", vbExclamation + vbOKOnly, Application.CompanyName)
            Return
            Exit Sub
        End If
        Dim news As Integer = MsgBox("Proceed to Transaction?", vbInformation + vbYesNo, Application.CompanyName)
    ...
    Private Sub toolErrorCorrect_Click(sender As Object, e As EventArgs) Handles toolErrorCorrect.Click
