...
Public Class maint_makefrm

    Private Sub maint_makefrm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
         LoadBrand()
    End Sub
    ...
    Sub LoadBrand()
        ...
        Do While rs.Read()
            ...
            li.SubItems.Add(rs.Item("makedesc").ToString())
        Loop
        rs.Close()
    ...
    Sub Save_Brand()
        ...
        With cmd
            ...
            .CommandText = "INSERT into maint_make(makedesc) " _
    ...
    Sub Save_Brand1()
        mySQLConnection.Open()
        Dim select_cmd As New SqlClient.SqlCommand("SELECT * from maint_make where makedesc LIKE '" & BrandTextBox.Text & "' ", mySQLConnection)
        Dim rs As SqlDataReader = select_cmd.ExecuteReader()
        'Dim i As Integer
        If rs.Read = True Then
            MsgBox("Maker Name is already exist!", vbCritical, "webSources")
            rs.Close()
            mySQLConnection.Close()
            'GoTo out
        Else
    ...
    Private Sub Dellete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Dellete.Click
        ...
        Else
            rs.Close()
            mySQLConnection.Close()
            MsgBox("Maker Name is not exist!", vbCritical, "webSources")
        End If
    ...
    Sub del_item_Brand()
        ...
        With cmd
            .Connection = mySQLConnection
            .CommandText = " DELETE from maint_make where makedesc LIKE '" & BrandTextBox.Text & "'"
            i = .ExecuteNonQuery
        End With
        'If i > 0 Then
