...
Public Class IS_Sales_Payments
    Dim Crystal_ReportShowOR As New ReportDocument
    ...
    Sub showPaymentDistribution()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.ICSConnection, Parameters, "mg_ShowPaymentDistribution")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                myDataReader.Read()
    ...
    Sub PrintOR()
        ...
        Dim reportPath As String = System.IO.Path.Combine(System.IO.Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "Rpt_OR.rpt")

        Crystal_ReportShowOR.Load(reportPath)
        ...
        CrTables = Crystal_ReportShowOR.Database.Tables
        ...
        Crystal_ReportShowOR.SetParameterValue("@ParamBranchCode", txt_branchcode.Text)
        Crystal_ReportShowOR.SetParameterValue("@ParamAccountNumber", txt_acctno.Text)
        Crystal_ReportShowOR.SetParameterValue("@ParamLedgerSetNumber", txt_LedSet.Text)
        Crystal_ReportShowOR.SetParameterValue("@ParamRefNo", txt_refno.Text)

        rpt_Receipt.cr_Receipt.ReportSource = Crystal_ReportShowOR
    ...
    Sub ShowVATOR()
        ...
        Using myDataReader As SqlDataReader = class_Database.Procedure_Retrieve(class_Database.ICSConnection, Parameters, "mg_ShowVatOR")
            If myDataReader IsNot Nothing AndAlso myDataReader.HasRows Then
                myDataReader.Read()
                ...
                postingdate2.Text = Format(myDataReader.Item("TransactionDate"), "MM/dd/yyyy")
    ...
    Sub PostPaymentUpdate()
        ...
        class_Database.Procedure_Save(class_Database.ICSConnection, Parameters, "Post_Payment_Update", "Post Payment", txt_refno.Text)
    End Sub
    ...
    Private Sub txt_totalamtpaid_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txt_totalamtpaid.TextChanged
        txt_numtoword.Text = AmountInWords(txt_totalamtpaid.Text)
    End Sub
