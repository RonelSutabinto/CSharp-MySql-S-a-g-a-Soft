...
{
    [DesignerGenerated()]
    public partial class frm_Adjustments : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colIs_15th = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colIs_30th = new DevExpress.XtraGrid.Columns.GridColumn();
			this.colAdjust_Name = new DevExpress.XtraGrid.Columns.GridColumn();
			...
			this.RepositoryItemLookUpEdit_COA_Code = new DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit();
			...
			this.xuc_Adjustment = new SagaHR.Controls.xuc_Adjustment();
			this.colCOA_Code = new DevExpress.XtraGrid.Columns.GridColumn();
			((System.ComponentModel.ISupportInitialize)(this.gridControl)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.RepositoryItemLookUpEdit_COA_Code)).BeginInit();
            ...
            this.RepositoryItemLookUpEdit_COA_Code});
			...
			this.colAdjust_Category.VisibleIndex = 2;
			// 
			// colAdjust_Type
			// 
			...
			this.colAdjust_Type.VisibleIndex = 3;
			// 
			// colIs_15th
			// 
			this.colIs_15th.FieldName = "Is_15th";
			this.colIs_15th.Name = "colIs_15th";
			this.colIs_15th.Visible = true;
			this.colIs_15th.VisibleIndex = 4;
			// 
			// colIs_30th
			// 
			this.colIs_30th.FieldName = "Is_30th";
			this.colIs_30th.Name = "colIs_30th";
			this.colIs_30th.Visible = true;
			this.colIs_30th.VisibleIndex = 5;
			// 
			// colAdjust_Name
			// 
			this.colAdjust_Name.Caption = "Name";
			this.colAdjust_Name.FieldName = "Adjust_Name";
			this.colAdjust_Name.Name = "colAdjust_Name";
			this.colAdjust_Name.Visible = true;
			this.colAdjust_Name.VisibleIndex = 6;
			// 
			// colAmount
			// 
			...
			// 
			this.colAdjust_Description.Caption = "Description";
			...
			this.colAdjust_Description.VisibleIndex = 9;
			// 
			// colNotes
			// 
			...
			this.colAdded_By.VisibleIndex = 11;
			// 
			// colAdded_Date
			// 
			...
			this.colAdded_Date.VisibleIndex = 12;
			// 
			// colModified_By
			// 
			...
			this.colModified_By.VisibleIndex = 13;
			// 
			// colModified_Date
			// 
			...
			this.colModified_Date.VisibleIndex = 14;
			// 
			// RepositoryItemLookUpEdit_COA_Code
			// 
			this.RepositoryItemLookUpEdit_COA_Code.AutoHeight = false;
			this.RepositoryItemLookUpEdit_COA_Code.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.RepositoryItemLookUpEdit_COA_Code.Name = "RepositoryItemLookUpEdit_COA_Code";
			// 
			// DockManager
			// 
			...
			// PanelControl
			// 
			this.PanelControl.Controls.Add(this.xuc_Adjustment);
			...
			// xuc_Adjustment
			// 
			this.xuc_Adjustment.Dock = System.Windows.Forms.DockStyle.Fill;
			this.xuc_Adjustment.Location = new System.Drawing.Point(2, 2);
			this.xuc_Adjustment.Name = "xuc_Adjustment";
			this.xuc_Adjustment.Size = new System.Drawing.Size(289, 433);
			this.xuc_Adjustment.TabIndex = 0;
			// 
			// colCOA_Code
			// 
			this.colCOA_Code.Caption = "Account Title";
			this.colCOA_Code.ColumnEdit = this.RepositoryItemLookUpEdit_COA_Code;
			this.colCOA_Code.FieldName = "COA_Code";
			this.colCOA_Code.Name = "colCOA_Code";
			this.colCOA_Code.Visible = true;
			this.colCOA_Code.VisibleIndex = 8;
			// 
			// frm_Adjustments
			// 
			...
			this.Text = "Employees";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.frm_Adjustments_FormClosing);
			this.Load += new System.EventHandler(this.frm_Adjustments_Load);
			this.Shown += new System.EventHandler(this.frm_Adjustments_Shown);
			((System.ComponentModel.ISupportInitialize)(this.gridControl)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.RepositoryItemLookUpEdit_COA_Code)).EndInit();
        ...
        internal DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit RepositoryItemLookUpEdit_COA_Code;
        ...
        internal DevExpress.XtraGrid.Columns.GridColumn colAdjust_Name;
        internal DevExpress.XtraGrid.Columns.GridColumn colAdjust_Description;
        ...
        internal Controls.xuc_Adjustment xuc_Adjustment;
		...
		private DevExpress.XtraGrid.Columns.GridColumn colIs_15th;
		private DevExpress.XtraGrid.Columns.GridColumn colIs_30th;
		private DevExpress.XtraGrid.Columns.GridColumn colCOA_Code;
	}
}