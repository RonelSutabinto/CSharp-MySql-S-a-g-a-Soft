...
namespace SagaSupport.Forms
{
	partial class frm_Editor
	{
		...
		private void InitializeComponent()
		{
			...
			this.Solution = new DevExpress.XtraRichEdit.RichEditControl();
			...
			// Solution
			// 
			this.Solution.ActiveViewType = DevExpress.XtraRichEdit.RichEditViewType.Simple;
			this.Solution.Dock = System.Windows.Forms.DockStyle.Fill;
			this.Solution.LayoutUnit = DevExpress.XtraRichEdit.DocumentLayoutUnit.Pixel;
			this.Solution.Location = new System.Drawing.Point(0, 150);
			this.Solution.MenuManager = this.ribbonControl;
			this.Solution.Name = "Solution";
			this.Solution.Size = new System.Drawing.Size(874, 354);
			this.Solution.SpellChecker = this.spellChecker;
			this.spellChecker.SetSpellCheckerOptions(this.Solution, optionsSpelling1);
			...
			this.ribbonControl.MaxItemId = 196;
			...
			this.ribbonControl.Size = new System.Drawing.Size(874, 150);
			// 
			// pasteItem1
			// 
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemRichEditFontSizeEdit1.Control = this.Solution;
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemBorderLineStyle1.Control = this.Solution;
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemBorderLineWeight1.Control = this.Solution;
			...
			// 
			this.changeSectionPageMarginsItem1.Id = 135;
			...
			// 
			this.setSectionLineNumberingRestartNewPageItem1.Id = 160;
			...
			// 
			this.setSectionLineNumberingRestartNewSectionItem1.Id = 161;
			...
			// changeLanguageItem1
			// 
			this.changeLanguageItem1.Id = 170;
			...
			// newCommentItem1
			// 
			this.newCommentItem1.Id = 174;
			this.newCommentItem1.Name = "newCommentItem1";
			// 
			// deleteCommentsItem1
			// 
			this.deleteCommentsItem1.Id = 175;
			...
			this.toggleTrackChangesBarItem1.Id = 181;
			...
			this.changeDisplayForReviewModeItem1.Id = 182;
			...
			this.showMarkupSubItem1.Id = 183;
			...
			// reviewingPaneItem1
			// 
			this.reviewingPaneItem1.Id = 184;
			...
			this.acceptAndMoveToNextSubItem1.Id = 185;
			...
			this.tableToolsRibbonPageCategory1.Control = this.Solution;
			...
			this.richEditBarController.Control = this.Solution;
			// 
			// frm_Help
			// 
			...
			this.Shown += new System.EventHandler(this.frm_Help_Shown);
		...
		internal DevExpress.XtraRichEdit.RichEditControl Solution;
