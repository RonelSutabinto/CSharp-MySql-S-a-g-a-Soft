...
Public Class SPA_Sales
    ...
    Sub SPA_Show_LedgerCode()
        ...
        Dim Parameters As SqlParameter() = {New SqlParameter("@ParamBranchCode", class_Saga_Variables.sBranchCode)}
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString(Date.Today(), TitleFont, Brushes.Black, 340, H)
