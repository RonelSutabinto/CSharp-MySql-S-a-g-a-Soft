...
Public Class frm_iREP_Units
    Public dt As DataTable
    Dim Ref_Number As String

    Private Sub frm_iREP_Units_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Initialize_GridList()
        ...
        'End If
    End Sub
    Private Sub frm_iREP_Units_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        Initialize_GridList()
    ...
    Private Sub frm_iREP_Units_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
        Form_Close()
    End Sub
    ...
    Private Sub btn_Send_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btn_Approval.ItemClick
        If class_Procedures.actionAsk("APPROVAL", "Send Depo to Repo for Approval") Then
            ...
            class_Procedures.Set_Message(class_Procedures.MsgMode.Info, "IREP TO REPO Sent for Approval", "FOR APPROVAL", True)
        End If
    ...
    Friend Sub Control_Save()
        For i = 0 To gridView.DataRowCount - 1
            Dim sqlParameters As SqlParameter() = {
                ...
                New SqlParameter("@WH_Category", "INACTIVE REPOSSESSED"),
                New SqlParameter("@WH_Code", "IREP"),
                ...
                New SqlParameter("@Branch_Code", "007"),
            ...
            class_Database.Procedure_Save(class_Database.SPAConnection, sqlParameters, "bj_Inventory_DepUnits", "DEPO TO REPO")
        Next
    End Sub
