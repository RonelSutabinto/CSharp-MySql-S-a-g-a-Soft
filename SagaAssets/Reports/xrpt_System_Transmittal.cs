...
{
    public partial class xrpt_System_Transmittal : DevExpress.XtraReports.UI.XtraReport
    {
        public xrpt_System_Transmittal()
        {
            InitializeComponent();
        }

        private void xrpt_System_Transmittal_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
